  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`rounded-full bg-[#ba1a1a] text-white flex items-center justify-center shadow-lg hover:bg-[#a11616] transition-all duration-300 transform hover:scale-110 active:scale-95 cursor-pointer ${
          showScrollTop
      ...
      >
        ...
        <button
          onClick={handleReset}
          className="rounded-full bg-[#ba1a1a] text-white flex items-center justify-center hover:bg-[#a11616] transition-all duration-200 transform hover:scale-105 active:scale-95 cursor-pointer font-bold select-none"
          style={{
            width: "32px",
            height: "32px",
            fontSize: "14px",
